...
public class ZipUtil {
     ...
     * @param apkPath
     * @param outPath
     * @param dirName      dir需要加后缀/ "lib/"
     */
    public static void upZipByDir(String apkPath, String outPath, String dirName) {
        ...
        try (ZipInputStream in = new ZipInputStream(new FileInputStream(zipFile))) {
            ...
            while ((zipEntry = in.getNextEntry()) != null) {
                ...
                if (zipEntryFileName.startsWith(dirName) && !zipEntry.isDirectory()) {
                    String replace = zipEntryFileName.replace(dirName, outPath);
                    // 创建解压缩目录
